...
struct SparseOccupancyGrid_
{
  ...
  _resolution_type resolution;
   ...
   typedef std::vector< ::jsk_recognition_msgs::SparseOccupancyGridColumn_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::jsk_recognition_msgs::SparseOccupancyGridColumn_<ContainerAllocator> >::other >  _columns_type;
