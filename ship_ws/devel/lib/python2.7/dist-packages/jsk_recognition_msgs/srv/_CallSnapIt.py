...
float64 z"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.request.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.request.target_plane.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.request.center.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.request.direction.header.frame_id = str[start:end].decode('utf-8')
      else:
