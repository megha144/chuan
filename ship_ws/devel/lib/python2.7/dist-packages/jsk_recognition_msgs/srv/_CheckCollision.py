...
"""autogenerated by genpy from jsk_recognition_msgs/CheckCollisionRequest.msg. Do not edit."""
import sys
...
class CheckCollisionRequest(genpy.Message):
  _md5sum = "2bfa8f4c4d92353b38f908fbabfac432"
  _type = "jsk_recognition_msgs/CheckCollisionRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """sensor_msgs/JointState joint
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.joint is None:
        self.joint = sensor_msgs.msg.JointState()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.joint.name)
      buff.write(_struct_I.pack(length))
      for val1 in self.joint.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.joint.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.joint.position))
      length = len(self.joint.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.joint.velocity))
      length = len(self.joint.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.joint.effort))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.joint.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.joint.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.joint.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.joint.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.joint.position.tostring())
      length = len(self.joint.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.joint.velocity.tostring())
      length = len(self.joint.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joint.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.joint.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
...
def _get_struct_7d():
    ...
    return _struct_7d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from jsk_recognition_msgs/CheckCollisionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class CheckCollisionResponse(genpy.Message):
  ...
  _type = "jsk_recognition_msgs/CheckCollisionResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class CheckCollision(object):
  _type          = 'jsk_recognition_msgs/CheckCollision'
  _md5sum = '3a30746acfb91fe161523d1e16f11286'
