...
"""autogenerated by genpy from jsk_recognition_msgs/ICPResult.msg. Do not edit."""
import sys
...
class ICPResult(genpy.Message):
  _md5sum = "2d0f1279ba6f378fd67c4a0324acf2d7"
  _type = "jsk_recognition_msgs/ICPResult"
...
float64 w
"""
  __slots__ = ['header','pose','name','score']
  _slot_types = ['std_msgs/Header','geometry_msgs/Pose','string','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ICPResult, self).__init__(*args, **kwds)
