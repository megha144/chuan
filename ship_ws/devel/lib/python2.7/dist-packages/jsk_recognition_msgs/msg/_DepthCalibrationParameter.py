...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.coefficients2))
      length = len(self.coefficients1)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.coefficients1))
      length = len(self.coefficients0)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.coefficients0))
      buff.write(_get_struct_B().pack(self.use_abs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.coefficients2 = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.coefficients1 = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.coefficients0 = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
