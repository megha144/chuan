  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.data:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sf'%length
        buff.write(struct.pack(pattern, *val1.xs))
        length = len(val1.ys)
        buff.write(_struct_I.pack(length))
        pattern = '<%sf'%length
        buff.write(struct.pack(pattern, *val1.ys))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.xs = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sf'%length
        ...
        val1.ys = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
