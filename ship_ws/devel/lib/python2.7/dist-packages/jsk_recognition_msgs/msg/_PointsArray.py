...
"""autogenerated by genpy from jsk_recognition_msgs/PointsArray.msg. Do not edit."""
import sys
...
class PointsArray(genpy.Message):
  _md5sum = "0aa7e57c9da77fc1a0d8277bba5672b1"
  _type = "jsk_recognition_msgs/PointsArray"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PointsArray, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.cloud_list is None:
        self.cloud_list = []
    else:
      self.header = std_msgs.msg.Header()
      self.cloud_list = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.cloud_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.cloud_list:
        _v1 = val1.header
