...
"""autogenerated by genpy from jsk_recognition_msgs/SlicedPointCloud.msg. Do not edit."""
import sys
...
class SlicedPointCloud(genpy.Message):
  _md5sum = "37376a48b034bf543f8cfd86844487c7"
  _type = "jsk_recognition_msgs/SlicedPointCloud"
...
"""
  __slots__ = ['point_cloud','slice_index','sequence_id']
  _slot_types = ['sensor_msgs/PointCloud2','uint8','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       point_cloud,slice_index,sequence_id
    ...
    """
    if args or kwds:
      super(SlicedPointCloud, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3B().pack(_x.point_cloud.is_dense, _x.slice_index, _x.sequence_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.point_cloud.is_dense, _x.slice_index, _x.sequence_id,) = _get_struct_3B().unpack(str[start:end])
