...
"""autogenerated by genpy from jsk_recognition_msgs/PosedCameraInfo.msg. Do not edit."""
import sys
...
class PosedCameraInfo(genpy.Message):
  _md5sum = "bfcbc4847adb445a428e4af537ed849a"
  _type = "jsk_recognition_msgs/PosedCameraInfo"
...
float64 w
"""
  __slots__ = ['header','camera_info','offset']
  _slot_types = ['std_msgs/Header','sensor_msgs/CameraInfo','geometry_msgs/Pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PosedCameraInfo, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6IB7d().pack(_x.camera_info.binning_x, _x.camera_info.binning_y, _x.camera_info.roi.x_offset, _x.camera_info.roi.y_offset, _x.camera_info.roi.height, _x.camera_info.roi.width, _x.camera_info.roi.do_rectify, _x.offset.position.x, _x.offset.position.y, _x.offset.position.z, _x.offset.orientation.x, _x.offset.orientation.y, _x.offset.orientation.z, _x.offset.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.camera_info.binning_x, _x.camera_info.binning_y, _x.camera_info.roi.x_offset, _x.camera_info.roi.y_offset, _x.camera_info.roi.height, _x.camera_info.roi.width, _x.camera_info.roi.do_rectify, _x.offset.position.x, _x.offset.position.y, _x.offset.position.z, _x.offset.orientation.x, _x.offset.orientation.y, _x.offset.orientation.z, _x.offset.orientation.w,) = _get_struct_6IB7d().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_6IB7d = None
def _get_struct_6IB7d():
    global _struct_6IB7d
    if _struct_6IB7d is None:
        _struct_6IB7d = struct.Struct("<6IB7d")
    return _struct_6IB7d
_struct_12d = None
def _get_struct_12d():
    global _struct_12d
