...
"""autogenerated by genpy from jsk_recognition_msgs/ParallelEdge.msg. Do not edit."""
import sys
...
class ParallelEdge(genpy.Message):
  _md5sum = "3a550d5b6275fe0a1580ebf8a62dd336"
  _type = "jsk_recognition_msgs/ParallelEdge"
...
"""
  __slots__ = ['header','cluster_indices','coefficients']
  _slot_types = ['std_msgs/Header','pcl_msgs/PointIndices[]','pcl_msgs/ModelCoefficients[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,cluster_indices,coefficients
    ...
    """
    if args or kwds:
      super(ParallelEdge, self).__init__(*args, **kwds)
