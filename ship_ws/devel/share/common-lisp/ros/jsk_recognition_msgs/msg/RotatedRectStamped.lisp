...
(cl:defclass <RotatedRectStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (rect
    :reader rect
    :initarg :rect
    :type jsk_recognition_msgs-msg:RotatedRect
    :initform (cl:make-instance 'jsk_recognition_msgs-msg:RotatedRect)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RotatedRectStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RotatedRectStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jsk_recognition_msgs-msg:<RotatedRectStamped> is deprecated: use jsk_recognition_msgs-msg:RotatedRectStamped instead.")))
...
(cl:defmethod rect-val ((m <RotatedRectStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jsk_recognition_msgs-msg:rect-val is deprecated.  Use jsk_recognition_msgs-msg:rect instead.")
  (rect m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RotatedRectStamped>)))
  ...
  "0260299b5425567e14c7b295b58829e9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RotatedRectStamped)))
  "Returns md5sum for a message object of type 'RotatedRectStamped"
  "0260299b5425567e14c7b295b58829e9")
