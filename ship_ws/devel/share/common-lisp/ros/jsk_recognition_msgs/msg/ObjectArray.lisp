...
(cl:defclass <ObjectArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (objects
    :reader objects
    :initarg :objects
    :type (cl:vector jsk_recognition_msgs-msg:Object)
   :initform (cl:make-array 0 :element-type 'jsk_recognition_msgs-msg:Object :initial-element (cl:make-instance 'jsk_recognition_msgs-msg:Object))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jsk_recognition_msgs-msg:<ObjectArray> is deprecated: use jsk_recognition_msgs-msg:ObjectArray instead.")))
...
(cl:defmethod objects-val ((m <ObjectArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jsk_recognition_msgs-msg:objects-val is deprecated.  Use jsk_recognition_msgs-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObjectArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'jsk_recognition_msgs-msg:Object))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObjectArray>)))
  ...
  "36314156578f919cf316fea64cc4a616")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObjectArray)))
  "Returns md5sum for a message object of type 'ObjectArray"
  "36314156578f919cf316fea64cc4a616")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjectArray>)))
  ...
  (cl:format cl:nil "Header header~%jsk_recognition_msgs/Object[] objects~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: jsk_recognition_msgs/Object~%# object instant info (ex. oreo_cookie)~%int32 id  # object id~%string name  # object name~%~%# object class info (ex. snack)~%int32 class_id~%string class_name~%~%string[] image_resources  # image urls~%string mesh_resource  # mesh file url~%~%float32 weight  # weight [kg]~%geometry_msgs/Vector3 dimensions  # bounding box [m]~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjectArray)))
  "Returns full string definition for message of type 'ObjectArray"
  (cl:format cl:nil "Header header~%jsk_recognition_msgs/Object[] objects~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: jsk_recognition_msgs/Object~%# object instant info (ex. oreo_cookie)~%int32 id  # object id~%string name  # object name~%~%# object class info (ex. snack)~%int32 class_id~%string class_name~%~%string[] image_resources  # image urls~%string mesh_resource  # mesh file url~%~%float32 weight  # weight [kg]~%geometry_msgs/Vector3 dimensions  # bounding box [m]~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
