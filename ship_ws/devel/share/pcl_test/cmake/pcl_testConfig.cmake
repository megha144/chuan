...
if("TRUE" STREQUAL "TRUE")
  set(pcl_test_SOURCE_PREFIX /home/xx/commonspace/ship_ws/src/pcl_test)
  set(pcl_test_DEVEL_PREFIX /home/xx/commonspace/ship_ws/devel)
  set(pcl_test_INSTALL_PREFIX "")
  set(pcl_test_PREFIX ${pcl_test_DEVEL_PREFIX})
else()
  set(pcl_test_SOURCE_PREFIX "")
  set(pcl_test_DEVEL_PREFIX "")
  set(pcl_test_INSTALL_PREFIX /home/xx/commonspace/ship_ws/install)
...
if(NOT "/home/xx/commonspace/ship_ws/src/pcl_test/include " STREQUAL " ")
  set(pcl_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/xx/commonspace/ship_ws/src/pcl_test/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xx/commonspace/ship_ws/src/pcl_test/${idir}'.  ${_report}")
    endif()
